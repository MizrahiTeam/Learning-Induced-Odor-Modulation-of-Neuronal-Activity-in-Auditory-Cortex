classdef odor_sound_neuron < handle & matlab.mixin.Heterogeneous
    ...
    properties
        ...
        responsive = 0 ;
        odor_responsiveness;
        pref_sound = -1 ; % 1 for Go 0 for NoGo
        exp_DI = zeros(1,3) ;
        exp_DI_diff = 0 ;
    ...
    methods
        ...
        function obj = odor_sound_neuron(BOT,trial_types,trial_odors,tSOF,tSOS,ft_all,lt_all,Parameters,is_early_punish)
            
            obj.Parameters = Parameters ;
            obj.make_dFF(BOT,trial_types,trial_odors,tSOF,tSOS,is_early_punish)
        ...
        function make_dFF(obj,BOT,trial_types,trial_odors,tSOF,tSOS,is_early_punish)
            ...
            for odor = 1 : 3
                for type = 1 : 4
                    ...
                    obj.is_early_punish{odor,type} = zeros(1,n_trials) ;
                end
            end
            ...
            for trial = 1 : length(trial_types)
                if trial_types(trial) < 7
                    ...
                    obj.is_early_punish{odor,type} = is_early_punish(trial) ;
                end
            end
...
%                     obj.valid_trials{odor,type}(:) = 1 ;
                    ...
                    obj.valid_trials{odor,type}(logical(obj.is_early_punish{odor,type})) = 0 ;
        ...
        function check_responsiveness(obj)
            ...
            obj.responsiveness = zeros(3,4) ;
            obj.inhibition = zeros(3,4) ;
            obj.odor_responsiveness = zeros(3,4) ;
